...
e = self, factory = function () {return function () {'use strict';var e = {216: function (e, t, s) {var i
          ...
          class _ {
            ...
            setConfig (e) {return e.recognitionLocale || (e.recognitionLocale = i.EN_GB), e.tokenGenerator && (this._authService = r.b.getInstance()), this._config = e, this._buildServerURL()}
          ...
          function P (e, {pattern:t, locale:s}) {let i
            i = 'string' == typeof e ? new Date(e) : e;const n = `${i.toLocaleDateString(s,{weekday:"short",day:"2-digit",month:"short"}).replace(/,/g,"")}, ${i.toLocaleTimeString(s,{hour:"numeric",minute:"numeric",hour12:0})}`
